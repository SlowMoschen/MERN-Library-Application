...
export default function Overview({ className, allBooks }) {
    ...
    const sumOfRatings = calculateSum(allBooks, 'rating')
            ...
            <div className={className}>
                ...
                <div className="h-full w-full flex flex-col">
                    ...
                    <div className="bg-secondary h-full w-full">
                        ...
                        <p>Average Rating: <span className="font-bold">{Math.floor(avgOfRatings)}</span></p>
                        <p>Read Books: <span className="font-bold">{readBooks.length}</span></p>
                        <p>Books to read: <span className="font-bold">{unreadBooks.length}</span></p>
